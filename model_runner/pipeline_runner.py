...
from .reactive_pipeline import ReactivePipeline
...
class PipelineRunner:
    ...
    Handles model registration (wrapping in ``TimedModule`` and ``ReactivePipeline``),
    ...
    def __init__(self, default_timing_depth: int = 3, verbose: bool = False):
        ...
        """
        self.pipelines: dict[str, ReactivePipeline] = {}
    ...
    def add_model(self, model_name: str, model: nn.Module, example_input: Any,
        ...
        ``ReactivePipeline`` which manages stage splitting and rebalancing.
        ...
        Args:
            ...
            **kwargs: Forwarded to ``ReactivePipeline``.
        ...
        self.pipelines[model_name] = ReactivePipeline(
            timed_model,
            model_name,
            self.device_manager,
            example_input,
