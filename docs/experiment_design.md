...
- [ ] Run C: GPipe baseline doesn't support interference yet — need to run it through `continuous_eval.py` with no-rebalance optimizer, or wrap the baseline script with the interference manager
